...
namespace EsecureWebApp.Data
{
    public class DummyData
    {
        ...
        //    {
        //        await roleManager.CreateAsync(new IdentityRole(role1, desc1, DateTime.Now));
        //    }
        //    if (await roleManager.FindByNameAsync(role2) == null)
        //    {
        //        await roleManager.CreateAsync(new IdentityRole(role2, desc2, DateTime.Now));
        //    }
